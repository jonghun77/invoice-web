...
**MVP 18 / 18 완료** (100%) · **고도화 11 / 11 Tasks 완료** (100%)
...
| 6     | 관리자 골격 & 인증 구조         | 3     | 3/3    | 완료   |
| 7     | 관리자 UI/UX (더미 데이터)      | 2     | 2/2    | 완료   |
| 8     | 관리자 데이터 연동 & 링크 공유  | 3     | 3/3    | 완료   |
| 9     | 다크모드 & 마무리               | 3     | 3/3    | 완료   |
...
- **Task T019: 관리자 라우팅 구조 및 레이아웃 골격** ✅
...
- **Task T024: 노션 Invoices DB 목록 조회 구현** ✅
